...
north <- read.delim(
  here::here("data/raw/2020-10-habitat/2020-10_south-west_BOSS_north_Dot Point Measurements.txt"),
...
south <- read.delim(
  here::here("data/raw/2020-10-habitat/2020-10_south-west_BOSS_south_Dot Point Measurements.txt"),
  header = TRUE, skip = 4, stringsAsFactors = FALSE,
  colClasses = "character", na.strings = ""
) %>%
  clean_names() %>%
...
west <- read.delim(
  here::here("data/raw/2020-10-habitat/2020-10_south-west_BOSS_west_Dot Point Measurements.txt"),
  header = TRUE, skip = 4, stringsAsFactors = FALSE,
  colClasses = "character", na.strings = ""
) %>%
  clean_names() %>%
...
east <- read.delim(
  here::here("data/raw/2020-10-habitat/2020-10_south-west_BOSS_east_Dot Point Measurements.txt"),
  header = TRUE, skip = 4, stringsAsFactors = FALSE,
  colClasses = "character", na.strings = ""
) %>%
  clean_names() %>%
