...
write.csv(corrtable, file = "output/PtCloates/multi_correlation-table.csv")
...
for(i in 1:length(resp.vars)){
  ...
  for(m in 1:nrow(out.i)){
    ...
    png(file = paste(savedir, paste0(m, resp.vars[i], "multi_mod_fits.png"), sep = "/"))
...
write.csv(all.mod.fits[ , -2], file = paste(savedir,paste(name, "multi_all.mod.fits.csv", sep = "."), sep = "/"))
write.csv(all.var.imp,         file = paste(savedir, paste(name, "multi_all.var.imp.csv", sep = "."), sep = "/"))
